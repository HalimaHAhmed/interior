          ...
          <img src={cartIcon} className="mt-8 mx-auto cursor-pointer" alt="" />
            ...
            <FadeIn delay={0.2} direction="up" padding fullWidth>
              <div className="relative  w-full  xs:w-[460px] mt-11">
                ...
                <input type="text" placeholder="search" className="rounded-full  w-full pl-6 pr-[68px] py-4 bg-primary outline-none text-base xs:text-lg placeholder-white text-white"/>

                <img src={searchIcon} alt="" className="absolute top-2 h-11 w-11 cursor-pointer right-3"/>
